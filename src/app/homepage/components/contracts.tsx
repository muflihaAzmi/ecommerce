...
function Contracts() {
  return (
    <div>
         <div className="md:w-full px-20 mt-10 flex flex-row  gap-4  ">
          ...
          <div className="w-130  flex flex-col  gap-4  ">
            ...
            <div>
              <Collapsible className=''>
                <div className=" border-t-2 border-b-2 py-4 w-[100px]">
                  ...
                  <CollapsibleContent>
                    <p className="text-gray-400 text-[10px] w-[100px]">
              ...
              <Collapsible>
                <div className="border-t-1 border-b-1 py-4 w-[100px] border-gray-300">
                  <CollapsibleTrigger className="flex justify-between text-[15px] w-[100px]">
