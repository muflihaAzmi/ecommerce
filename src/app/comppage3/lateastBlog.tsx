...
function LeatestBlog() {
  ...
  return (
    <div className="container mx-auto w-[90%] min-h-screen mt-30 ">
      <div className=" border-l border-r px-30">
        <div className="flex lg:flex-row lg:justify-between sm:flex-col w-full flex-col  p-5">
          <h2
            className={`text-black lg:text-6xl text-4xl  md:w-[600px]  font-semibold w-full tracking-tighter [word-spacing:0.1px] leading-none ${spaceGrotesk.className}`}
          >
