  ...
  return (
    <>
      <div className="w-full h-[100lvh]  mt-20">
        <div className="md:px-30 mt-16 gap-0 container w-[90%] mx-auto border-l border-r">
          <p
            ...
            <div className="row-span-2 ">
              ...
              >
                ...
                <p className="text-white mt-8 font-semibold text-2xl">
                  Pointer has been a great tool for our businesses. We wanted an
                  all-in-one solution that was seamless for clients to use, and
